...
hi Normal        guifg=#1a1a1a  guibg=#fff9f1
hi Title         guifg=black    guibg=#fff9f1
hi Cursor        guibg=#111111
hi LineNr        guifg=#aaaaaa  guibg=#fff9f1
hi Visual        guibg=#bbddff
hi NonText       guifg=#cccccc  guibg=#fff9f1
...
hi Error         guifg=#bb3355  guibg=#fff9f1    gui=none
...
"hi Todo          guifg=#225522  guibg=#fff9f1    gui=italic
